...
if __name__ == '__main__':
	try:
		...
		if not strm_read.startswith('plugin://plugin.video.onemoar'):
			import xbmcgui
			xbmcgui.Dialog().notification(heading='OneMoar', message='.strm file failure')
	...
	if xbmcaddon.Addon().getSetting("context.onemoar.rescrape2") == 'true':
		rescrape_method = xbmcaddon.Addon().getSetting("context.onemoar.rescrape3")
