...
prop_dict = {'default': 'affenity_%s_default', 'edited': 'affenity_%s_edited', 'shortcut_folder': 'affenity_%s_shortcut_folder'}
timeout = 60
...
main_menu_items = {'RootList': {'name': 'Root', 'iconImage': 'affenity', 'mode': 'navigator.main', 'action': 'RootList'}, 'MovieList': root_list[0], 'TVShowList': root_list[1]}
...
class NavigatorCache:
	...
	def rebuild_database(self):
		from caches.base_cache import database_integrity_check
		database_integrity_check(limited='navigator_db', silent=True)
